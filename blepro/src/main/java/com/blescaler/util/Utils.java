...
public class Utils {
  ...
  public static String UUID_DATA = "0000FFE1-0000-1000-8000-00805F9B34FB";  //HC-08
  ...
  static {
    ...
    BLE_CHARACTERISTICS.put("00002A44-0000-1000-8000-00805F9B34FB",
    ...
    BLE_CHARACTERISTICS.put("00002A2A-0000-1000-8000-00805F9B34FB",
    ...
    BLE_CHARACTERISTICS.put("00002A04-0000-1000-8000-00805F9B34FB",
    ...
    BLE_CHARACTERISTICS.put("00002A48-0000-1000-8000-00805F9B34FB",
  ...
  public static float ArrayToFloat(byte[] Array, int Pos) {
    int accum = 0;
  ...
  public static float Int2Float(int value, int dot) {

    float num = (float) Math.pow(10, dot);
  ...
  public static String FormatFloatValue(float value, int dot) {
    ...
    switch (dot) {
      case 1:
        weight = String.format("%.1f", value).toString();
        break;
      case 2:
        weight = String.format("%.2f ", value).toString();
        break;
      case 3:
        weight = String.format("%.3f", value).toString();
        break;
      case 4:
        weight = String.format("%.4f", value).toString();
        break;
      case 5:
        weight = String.format("%.5f", value).toString();
        break;
      case 6:
        weight = String.format("%.6f", value).toString();
        break;
      default:
        weight = String.format("%d", (int) value);
        break;
    }
    return weight;
  }

  public static String FormatIntValue(int value, int dot) {
    String weight = "------";
    float wf = value;
    switch (dot) {
      case 1:
